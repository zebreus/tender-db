...
/// A corpus exercising every grouping regime path-B must reproduce under resume:
/// keyed chains, legacy OJS chains ingested far apart, a bridge notice merging two
/// legacy components (the union-find merge), and islands.
...
/// resumes a genuinely-interrupted run, never a completed one.
#[tokio::test]
