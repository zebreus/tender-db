...
<ul>
  ...
  <li>Limits per token: 2 concurrent queries, 300 per hour, 10 s per query. Over-limit is <code>429</code> with <code>Retry-After</code>; a query past the time limit is <code>408</code>.</li>
