...
- **open**: `skipped snapshot: job N is running — next timer firing retries` as the latest line, i.e. the week's snapshot was lost to the collision (read 2026-09-19: the 09-13 line, then the hand-fired run at the foot)
