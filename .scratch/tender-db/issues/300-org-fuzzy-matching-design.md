...
Status: STAGES 0–2 LIVE, 3 RUNNING, 4 CONSUMED, 5 MEASURED EMPTY, v2.1 DONE (refreshed 2026-09-06 06:5x) — Stage 1 (v2 gate + placeholder dissolve) COMPLETE 2026-08-29 (7,865/7,865); Stage 2 (canonical_key, r2-census, `match-org-identifiers --r2`) live 2026-08-29 and the R2 loop is the fold behind every campaign since; R3 runs (310 prevention deployed 08-29; the CNFPT family verified against the merge ledger 09-03); Stage 4's edge store is consumed — the same-name cross-border packet (`xb-country-cases`, issue 355's 487-case campaign, 153 rows moved 2026-09-05) reads it, and the identifier-keyed cluster census/packet (357: six slices, 1,100+ rows moved, 700+ duplicate identities folded) covers the shape 326 named; gate v2.1 folds deployed and the standing rows repaired (345/346, 2026-09-04: 2,409 rows, R2 1,846 groups); Stage 5 census built 2026-09-04 in the weekly org-merge-health walk (`null_country` bucket; first reading Sunday 2026-09-06). Stage 5's first census reading (2026-09-06 02:46): 3,529 NULL-country national rows, 3,528 distinct values, ONE value shared by two rows and they carry one name — the shared-bucket class does not exist at any size, nothing to build (details below). Open: Stage 6 (DE court-scope demotion, deferred), 329's E0 fold wet run (awaits Lennart); since issue 362 a reviewed E0 group can also go through a merge verdict. Was: STAGES 0–2 LIVE, 3–4 PARTLY (refreshed 2026-09-03; the line below was stale) — Stage 1 (v2 gate + placeholder dissolve) COMPLETE 2026-08-29 (7,865/7,865); Stage 2 (canonical_key, r2-census, `match-org-identifiers --r2`) live 2026-08-29; R3 runs (310 prevention deployed 08-29; the CNFPT family verified against the merge ledger 09-03); Stage 4 edge store built (314, consumer pending); Stage 0 exemplar sheet finished 2026-09-03 (top-100 classified, Bertin census ≈ 0, Kærunefnd flag-only). Open: Stage 5 (NULL-country bucket), Stage 6, and a gate v2.1 from the top-100 read — four classes to CENSUS first (phone `t:` ids, DE ≤5-digit numerics under raw scheme EU, Greek/Latin confusable fold, RO `_n` suffix). Was: DESIGNED 2026-08-28 — full design below; build not started. Produced
...
Stage 5 first reading (2026-09-06 02:46 UTC, the weekly org-merge-health job 754):
`null_country` = {orgs 3,529, values 3,528, shared_values 1, shared_orgs 2, max_bucket 2
(`A80364243`, a Spanish CIF), sampled_buckets 1, same_name 1, mixed_names 0}. The class
§8 asked to size before building — `(None, national, v)` as a shared resolver bucket
fusing strangers — is one bucket of two same-named rows. Stage 5's prevention and repair
